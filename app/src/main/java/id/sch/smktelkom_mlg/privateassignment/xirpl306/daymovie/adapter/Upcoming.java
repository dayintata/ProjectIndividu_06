...
public class Upcoming extends RecyclerView.Adapter<Upcoming.ViewHolder> {
    ...
    UpcominFragment upcominFragment;
    Context context;
    private int lastpositin = -1;

    public Upcoming(UpcominFragment upcominFragment, ArrayList<Results> mList, Context context) {
        this.mList = mList;
        this.upcominFragment = upcominFragment;
