...
public class Playing extends RecyclerView.Adapter<Playing.ViewHolder> {
    ...
    public Playing(PlayingFragment playingFragment, ArrayList<Results> mList, Context context) {
        this.mList = mList;
