...
import id.sch.smktelkom_mlg.privateassignment.xirpl306.daymovie.adapter.Upcoming;
 ...
 */
public class UpcominFragment extends Fragment {
    ArrayList<Results> mList = new ArrayList<>();
    Upcoming upcoming;

    public UpcominFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        upcoming = new Upcoming(this, mList, getContext());
        rv.setAdapter(upcoming);
    ...
    private void downloadDataResource() {
        String url = " https://api.themoviedb.org/3/movie/upcoming?api_key=0e319904e648248b800ac4a16ce41acf&language=en-US&page=1";
