package id.sch.smktelkom_mlg.privateassignment.xirpl306.daymovie.adapter;
...
import id.sch.smktelkom_mlg.privateassignment.xirpl306.daymovie.DetailActivity;
import id.sch.smktelkom_mlg.privateassignment.xirpl306.daymovie.R;
...
public class Rated extends RecyclerView.Adapter<Rated.ViewHolder> {
    public String url = "https://image.tmdb.org/t/p/w500";
    public String image;
    ArrayList<Results> mList;
    RatedFragment ratedFragment;
    Context context;
    private int lastpositin = -1;

    public Rated(RatedFragment ratedFragment, ArrayList<Results> mList, Context context) {
        this.mList = mList;
        this.ratedFragment = ratedFragment;
